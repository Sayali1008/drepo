...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">WORKSHOPS</h1>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin-bottom:0%;">
                        ...
                        <input type="submit" class="btn text-left" style="width:100%; font-family: 'Libre Franklin', sans-serif;" name="workshop" value="According to Workshops">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname, s.sclass FROM workshops AS w, student AS s WHERE s.aid = '$id' AND w.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['worganization'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname, s.sclass FROM workshops AS w, student AS s WHERE s.aid = '$id' AND w.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        } elseif (isset($_POST['workshops'])) {
                            // <!----------------------------------------------------------------------- WORKSHOP WISE -->
                            $sql4 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname, s.sclass FROM workshops AS w, student AS s WHERE s.aid = '$id' AND w.uid = s.sid ORDER BY w.wname ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname, s.sclass FROM workshops AS w, student AS s WHERE s.aid = '$id' AND w.uid = s.sid AND w.startdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname, s.sclass FROM workshops AS w, student AS s WHERE s.aid = '$id' AND w.uid = s.sid";
