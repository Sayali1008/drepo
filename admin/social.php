...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">SOCIAL ACTIVITIES</h1>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname, s.sclass FROM social AS sa, student AS s WHERE s.aid = '$id' AND sa.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['satopic'] ?></td>
                                    <td><?php echo $row['saorganization'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname, s.sclass FROM social AS sa, student AS s WHERE s.aid = '$id' AND sa.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- TOPIC WISE -->
                            $sql4 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname, s.sclass FROM social AS sa, student AS s WHERE s.aid = '$id' AND sa.uid = s.sid ORDER BY sa.satopic ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname, s.sclass FROM social AS sa, student AS s WHERE s.aid = '$id' AND sa.uid = s.sid AND sa.startdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname, s.sclass FROM social AS sa, student AS s WHERE s.aid = '$id' AND sa.uid = s.sid";
