...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">COMPETITIONS</h1>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin-bottom:0%;">
                        ...
                        <!-- <input type="submit" class="btn text-left" style="width:100%; font-family: 'Libre Franklin', sans-serif;" name="organization" value="According to Organization"> -->
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname, s.sclass FROM competitions AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['ctopic'] ?></td>
                                    <td><?php echo $row['cname'] ?></td>
                                    <td><?php echo $row['corganization'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname, s.sclass FROM competitions AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- RANK WISE -->
                            $sql5 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname, s.sclass FROM competitions AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid ORDER BY c.rank ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname, s.sclass FROM competitions AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid AND c.cdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname, s.sclass FROM competitions AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid";
