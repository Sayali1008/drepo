...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">EXTRA-CURRICULAR ACTIVITIES</h1>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin-bottom:0%;">
                        ...
                        <input type="submit" class="btn text-left" style="width:100%; font-family: 'Libre Franklin', sans-serif;" name="portfolio" value="According to Portfolio">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['oportfolio'] ?></td>
                                    <td><?php echo $row['oname'] ?></td>
                                    <td><?php echo $row['oorganization'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- PORTFOLIO NAME WISE -->
                            $sql4 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid ORDER BY oportfolio ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- RANK WISE -->
                            $sql5 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid ORDER BY o.rank ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid AND o.odate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, odate, o.rank, o.certi, s.sfname, s.slname, s.sclass FROM others as o, student AS s WHERE s.aid = '$id' AND o.uid = s.sid";
