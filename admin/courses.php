...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">COURSES</h1>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi, s.sfname, s.slname, s.sclass FROM courses AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi, s.sfname, s.slname, s.sclass FROM courses AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi, s.sfname, s.slname, s.sclass FROM courses AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid AND c.startdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi, s.sfname, s.slname, s.sclass FROM courses AS c, student AS s WHERE s.aid = '$id' AND c.uid = s.sid";
