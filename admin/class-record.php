...
$student_class = $_SESSION['student-class'];
...
if (isset($_POST['logout'])) {
    ...
    // onclick="window.location.href = '../index/index.php';"
}
...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%; text-transform:uppercase;">Report for <?php echo $student_class ?></h1>
    </div>
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi, s.sfname, s.slname FROM workshops AS w, student AS s WHERE w.uid = s.sid AND s.sclass='$student_class'";
                ...
                if ($result1->num_rows > 0) {
                    ...
                    while ($row = $result1->fetch_array()) {
                        ...
                        <tr>
                            <th><?php echo $i ?></th>
                            <th><?php echo $row['sfname'] . " " . $row['slname'] ?></th>
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname FROM internships AS i, student AS s WHERE i.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi, s.sfname, s.slname FROM courses AS c, student AS s WHERE c.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT r.rid, r.rtitle, r.rtopic, r.rorganization, r.rdate, r.certi, s.sfname, s.slname FROM research AS r, student AS s WHERE r.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname FROM projects AS p, student AS s WHERE p.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi, s.sfname, s.slname FROM competitions AS c, student AS s WHERE c.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi, s.sfname, s.slname FROM social AS sa, student AS s WHERE sa.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
    ...
    <div class="container" style="margin-top:3%;">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                <?php
                $sql1 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, o.odate, o.rank, o.certi, s.sfname, s.slname FROM others AS o, student AS s WHERE o.uid = s.sid AND s.sclass='$student_class'";
                $result1 = $conn->query($sql1);
