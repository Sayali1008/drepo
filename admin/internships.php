...
<body>
    ...
    <!----------------------------------------------------------------------- PAGE HEAD -->
    <div class="container">
        <h1 class="text-center" style="font-family: 'Merriweather', serif; margin-bottom:4%;">INTERNSHIPS</h1>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin-bottom:0%;">
                        ...
                        <input type="submit" class="btn text-left" style="width:100%; font-family: 'Libre Franklin', sans-serif;" name="organization" value="According to Company">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname, s.sclass FROM internships AS i, student AS s WHERE s.aid = '$id' AND i.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['idepartment'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname, s.sclass FROM internships AS i, student AS s WHERE s.aid = '$id' AND i.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql4 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname, s.sclass FROM internships AS i, student AS s WHERE s.aid = '$id' AND i.uid = s.sid ORDER BY i.icompany ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname, s.sclass FROM internships AS i, student AS s WHERE s.aid = '$id' AND i.uid = s.sid  AND i.startdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi, s.sfname, s.slname, s.sclass FROM internships AS i, student AS s WHERE s.aid = '$id' AND i.uid = s.sid";
