        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['classwise'])) {
                    // <!----------------------------------------------------------------------- CLASSWISE -->
                    $sql2 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname, s.sclass FROM projects AS p, student AS s WHERE s.aid = '$id' AND p.uid = s.sid ORDER BY s.sclass ASC";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        while ($row = $result2->fetch_array()) {
                            ...
                            <tr>
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" style="margin:0%;">
                                    ...
                                    <td><?php echo $row['ptopic'] ?></td>
                                    <td><?php echo $row['porganization'] ?></td>
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- STUDENT NAME WISE -->
                            $sql3 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname, s.sclass FROM projects AS p, student AS s WHERE s.aid = '$id' AND p.uid = s.sid ORDER BY s.sfname ASC, s.slname ASC";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- TOPIC WISE -->
                            $sql4 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname, s.sclass FROM projects AS p, student AS s WHERE s.aid = '$id' AND p.uid = s.sid ORDER BY p.ptopic ASC";
                        ...
                        <?php
                            ...
                            $sql6 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname, s.sclass FROM projects AS p, student AS s WHERE s.aid = '$id' AND p.uid = s.sid AND p.startdate BETWEEN '$startdate' AND '$enddate'";
                        ...
                        <?php
                            ...
                            // <!----------------------------------------------------------------------- GENERAL -->
                            $sql1 = "SELECT p.pid, p.ptitle, p.ptopic, p.porganization, p.startdate, p.duration, p.certi, s.sfname, s.slname, s.sclass FROM projects AS p, student AS s WHERE s.aid = '$id' AND p.uid = s.sid";
