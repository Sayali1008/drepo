...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO competitions(ctopic, cname, corganization, cdate, duration, rank, certi, uid) VALUES('$topic', '$name', '$org', '$date', '$time', '$rank', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi FROM competitions AS c, student AS s WHERE c.uid = s.sid AND s.sid='$id' AND c.cdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT c.cid, c.ctopic, c.cname, c.corganization, c.cdate, c.duration, c.rank, c.certi FROM competitions AS c, student AS s WHERE c.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="ttopic" placeholder="Competition Topic">
                                    <input type="text" id="input-text12" class="input-field" name="nname" placeholder="Competition Name">
                                    ...
                                    <input type="number" id="input-number" class="input-field" name="ttime" min=1 placeholder="Competition Duration (No. of days)">

                                    <label for="" style="font-family: 'Ubuntu', sans-serif; font-size:20px;">&nbsp;&nbsp;Rank : &nbsp;&nbsp;&emsp;</label>
                                    <select name="rrank" id="input-text14" class="custom-select-lg input-field">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="input-file" style="cursor:pointer;" name="iimg" value="image">
