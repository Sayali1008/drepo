...
<body>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-3">
                <a href="workshops.php" style="color:black; text-decoration:none;" class="page-style">
            ...
            <div class="col-md-3">
                <a href="internships.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
                        <div class="card-title">INTERNSHIPS</div>
                    </div>
                </a></div>
            <div class="col-md-3">
                <a href="courses.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
            ...
            <div class="col-md-3">
                <a href="research.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
        ...
        <div class="row">
            <div class="col-md-3">
                <a href="projects.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
            ...
            <div class="col-md-3">
                <a href="competitions.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
            ...
            <div class="col-md-3">
                <a href="social.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
            ...
            <div class="col-md-3">
                <a href="others.php" style="color:black; text-decoration:none;" class="page-style">
                    <div class="card container card-style">
