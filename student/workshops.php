...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO workshops(wname, worganization, startdate, duration, certi, uid) VALUES('$name', '$org', '$date', '$time', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql1 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi FROM workshops AS w, student AS s WHERE w.uid = s.sid AND s.sid='$id' AND w.startdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result1->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT w.wid, w.wname, w.worganization, w.startdate, w.duration, w.certi FROM workshops AS w, student AS s WHERE w.uid = s.sid AND s.sid='$id'";
                            $result1 = $conn->query($sql1);
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text12" class="input-field" name="nname" placeholder="Workshsop Name">
                                    ...
                                    <input type="number" id="input-number" class="input-field" name="ttime" min=1 placeholder="Workshop Duration (No. of days)">
