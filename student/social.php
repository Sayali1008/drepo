...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO social(saname, satopic, saorganization, startdate, duration, certi, uid) VALUES('$name', '$topic', '$org', '$date', '$time', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi FROM social AS sa, student AS s WHERE sa.uid = s.sid AND s.sid='$id' AND sa.startdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT sa.said, sa.saname, sa.satopic, sa.saorganization, sa.startdate, sa.duration, sa.certi FROM social AS sa, student AS s WHERE sa.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="nname" placeholder="Activity Name">
                                    <input type="text" id="input-text12" class="input-field" name="ttopic" placeholder="Activity Topic">
                                    ...
                                    <input type="number" id="input-number" class="input-field" name="ttime" min=1 placeholder="Activity Duration (No. of days)">
