...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO others(oportfolio, oname, oorganization, odate, rank, certi, uid) VALUES('$port', '$name', '$org', '$date', '$rank', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, o.odate, o.rank, o.certi FROM others AS o, student AS s WHERE o.uid = s.sid AND s.sid='$id' AND o.odate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT o.oid, o.oportfolio, o.oname, o.oorganization, o.odate, o.rank, o.certi FROM others AS o, student AS s WHERE o.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="pport" placeholder="Portfolio">
                                    <input type="text" id="input-text12" class="input-field" name="nname" placeholder="Event Name">
                                    <input type="text" id="input-text13" class="input-field" name="oorg" placeholder="Organization/College">
                                    <label for="input-date" style="font-family: 'Ubuntu', sans-serif; font-size:20px;">&nbsp;&nbsp;Date : &nbsp;&nbsp;&emsp;</label>
