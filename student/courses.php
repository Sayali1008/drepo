...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO courses(cname, corganization, startdate, duration, certi, uid) VALUES('$name', '$org', '$date', '$time', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi FROM courses AS c, student AS s WHERE c.uid = s.sid AND s.sid='$id' AND c.startdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT c.cid, c.cname, c.corganization, c.startdate, c.duration, c.certi FROM courses AS c, student AS s WHERE c.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="nname" placeholder="Name of the Course">
                                    <input type="text" id="input-text12" class="input-field" name="oorg" placeholder="Organization/Company">
                                    ...
                                    <input type="number" id="input-number" class="input-field" name="ttime" min=1 placeholder="Course Duration (No. of days)">
                                    <br>
                                    <br>
