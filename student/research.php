...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO research(rtitle, rtopic, rorganization, rdate, certi, uid) VALUES('$title', '$topic', '$org', '$date', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT r.rid, r.rtitle, r.rtopic, r.rorganization, r.rdate, r.certi FROM research AS r, student AS s WHERE r.uid = s.sid AND s.sid='$id' AND r.rdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT r.rid, r.rtitle, r.rtopic, r.rorganization, r.rdate, r.certi FROM research AS r, student AS s WHERE r.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="ttitle" placeholder="Paper Title">
                                    <input type="text" id="input-text12" class="input-field" name="ttopic" placeholder="Paper Topic">
