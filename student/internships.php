...
if (isset($_POST['add'])) {
    ...
    $insert_query = "INSERT INTO internships(icompany, idepartment, startdate, duration, certi, uid) VALUES('$org', '$dept', '$date', '$time', '$folder', '$id')";
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $sql2 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi FROM internships AS i, student AS s WHERE i.uid = s.sid AND s.sid='$id' AND i.startdate BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if ($result2->num_rows > 0) {
                        ...
                        <?php
                            ...
                            $sql1 = "SELECT i.iid, i.icompany, i.idepartment, i.startdate, i.duration, i.certi FROM internships AS i, student AS s WHERE i.uid = s.sid AND s.sid='$id'";
                        ...
                        <div class="modal-content" style="border: 1px solid #00424d;">
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data" style="margin:0%;">
                                ...
                                <div class="modal-body" style="background-color: #c8e3e8; margin:1px;">
                                    <input type="text" id="input-text11" class="input-field" name="oorg" placeholder="Organization/Company">
                                    <input type="text" id="input-text12" class="input-field" name="ddept" placeholder="Working Department">
                                    ...
                                    <input type="number" id="input-number" class="input-field" name="ttime" min=1 placeholder="Work Duration (No. of days)">
                                    <br>
                                    <br>
